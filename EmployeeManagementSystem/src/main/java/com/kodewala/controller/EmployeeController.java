...
public class EmployeeController {
	...
	public String saveEmployee(@ModelAttribute Employee employee, Model model) {
		java.lang.Long id = employeeService.saveEmployee(employee);
	...
	@GetMapping("/all")
	public String getAllEmployees(Model model, @RequestParam(value = "message", required = false) String message) {
	...
	public String editEmployee(@RequestParam Long id, Model model, RedirectAttributes attributes) {
		String page = null;
		try {
			Employee ob = employeeService.getOneEmployee(id);
